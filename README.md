...
### Scenario1: Dividing numbers result in a decimal number
...
### Scenario2: Validation when values are missing
...
### Scenario3: An invalid division should log an error in the console
...
### Scenario4: Providing anything that is not a number should crash the program
